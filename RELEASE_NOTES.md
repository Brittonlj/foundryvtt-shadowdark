...
- [#1172] Adding names to random name tables displays HTML tags on character generator *(Brittonlj)*
- [#1179] Torch pickup icon doesn't appear in item HUD *(BrittonLJ)*
